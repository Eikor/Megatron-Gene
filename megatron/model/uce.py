...
class UCEModel(MegatronModule):
    ...
    def __init__(self,
        ...
        # assert args.pipeline_model_parallel_size == 1, 'Ensure pp=1 when init wte with ESM embeddings'
        self.initialize_word_embeddings(init_method_normal)
        # self.word_embeddings.weight = torch.load('wte.pt')
